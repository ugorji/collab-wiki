...
/**
 * Represents a lock object, which encapsulates the user editing the page, the page being edited,
 * and the time at which the lock to edit the page was acquired.
 *
 * @author ugorji
 */
public class WikiEditLock implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if ((username == null && o2.username != null)
        || (!username.equals(o2.username))
        || (pagename == null && o2.pagename != null)
        || (!pagename.equals(o2.pagename))) {
      return false;
    }
    return true;
  }
